...
function [precision, fps] = run_tracker(video, kernel_type, feature_type, show_visualization, show_plots)
	...
	base_path = 'D:\8th semester\Thesis submission 01\2017521460070_MD_MIRAJ_ISLAM (First Submission)\Code\Dataset';
	...
	assert(any(strcmp(kernel_type, {'gaussian'})), 'Unknown kernel.')
